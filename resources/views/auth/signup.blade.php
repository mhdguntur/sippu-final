...
@section('content')
	<h3 class="mt-5 text-center">Daftar Sebagai Pelaku UMKM</h3>
			...
			<form action="{{ url('register') }}" method="post" autocomplete="off">
				...
				<div class="row mb-3">
					...
					<div class="col-md col-md-sm-12">
						...
						<input type="text" value="{{ old('tenaga_tidak_tetap') }}" name="tenaga_tidak_tetap" id="tenaga_tidak_tetap"
							class="form-control @error('tenaga_tidak_tetap') is-invalid @enderror">
				...
				<div class="row mb-5">
					...
					<div class="col-md col-md-sm-12">
						...
						<div class="d-flex">
							<div class="form-check">
								<input type="radio" name="laporan_keuangan" id="laporan_keuangan" value="Ya" class="form-check-input">
								<label for="laporan_keuangan" class="form-check-label">Ya</label>
							</div>
							<div class="form-check ml-5">
								<input type="radio" name="laporan_keuangan" id="laporan_keuangan" value="Tidak" class="form-check-input">
				...
				<div class="row mb-3">
					...
					<div class="col-md col-md-sm-12">
						...
						<input type="text" value="{{ old('jangkauan_pemasaran') }}" name="jangkauan_pemasaran"
							id="jangkauan_pemasaran" class="form-control @error('jangkauan_pemasaran') is-invalid @enderror">
				...
				<div class="row mb-3">
					...
					<div class="col-md col-md-sm-12">
						...
						<input type="text" value="{{ old('pemasaran_online') }}" name="pemasaran_online" id="pemasaran_online"
				...
				<div class="d-flex justify-content-center">
					<button type="submit" class="btn btn-success w-50 mt-5">Sign Up</button>
				</div>
			</form>
		</div>
	</div>
